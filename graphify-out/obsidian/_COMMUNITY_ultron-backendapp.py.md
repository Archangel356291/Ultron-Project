...
- 25 edges to [[_COMMUNITY_route]]
- 16 edges to [[_COMMUNITY_run_ultron_chat]]
- 8 edges to [[_COMMUNITY__get_db_connection]]
- 7 edges to [[_COMMUNITY_trades]]
- 7 edges to [[_COMMUNITY__status_data]]
- 6 edges to [[_COMMUNITY_docker_ps]]
- 6 edges to [[_COMMUNITY__fifo_engine]]
- 6 edges to [[_COMMUNITY_scan_container_cves]]
- 5 edges to [[_COMMUNITY_require_role]]
- 1 edge to [[_COMMUNITY_anthropic__init__.py]]

## Top bridge nodes
- [[ultron-backendapp.py]] - degree 98, connects to 10 communities
