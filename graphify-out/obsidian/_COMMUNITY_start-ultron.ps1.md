...
```dataview
TABLE source_file, type FROM #community/start-ultronps1
SORT file.name ASC
```
...
- 2 edges to [[_COMMUNITY_Flask Backend (app.py)]]
- 2 edges to [[_COMMUNITY_MCP (external toolplugin) Support]]
- 1 edge to [[_COMMUNITY_Testing Ultron — a quick guide]]
- 1 edge to [[_COMMUNITY_authHeaders]]
- 1 edge to [[_COMMUNITY_CryptoTrade Record & Tax Agent]]

## Top bridge nodes
- [[Phase 1 Status (complete, 2026-09-13)]] - degree 7, connects to 3 communities
