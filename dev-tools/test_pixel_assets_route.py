...
2026-09-16 -- sprites/backdrop for the Odin tab's pixel companion,
...
def demo():
    ...
    res = client.get("/pixel-assets/../odin-backend/app.py")
    assert res.status_code in (403, 404), f"path traversal should be refused, got {res.status_code}"
    res = client.get("/pixel-assets/..%2f..%2fodin-backend%2fapp.py")
