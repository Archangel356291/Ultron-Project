"""Self-check for ULTRON_ADMIN_USERNAME (owner-requested 2026-09-15: mark the
...
def demo():
    ...
    print("OK: ULTRON_ADMIN_USERNAME overrides the admin identity in /api/whoami and chat_log, "
